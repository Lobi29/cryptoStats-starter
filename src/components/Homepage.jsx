  ...
  return (
    <>
      ...
      <div className="home-heading-container">
        <Title level={2} className="home-title heading">Top 10 Cryptocurrencies in the world</Title>
      ...
      <div className="home-heading-container">
        <Title level={2} className="home-title heading">Latest Crypto News</Title>
        <Title level={2} className="show-more">
